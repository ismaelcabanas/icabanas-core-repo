...
/**
 * Implementaci�n abstracta de {@link IGenericSoloLecturaDao}.
 * 
 * <br/><br/>
...
//		try{
//			Validate.isTrue(paginaActual >= 1, "La p�gina actual de la paginaci�n debe ser >= 1.");
//			Validate.isTrue(numeroRegistrosPorPagina > 0, "La p�gina actual de la paginaci�n debe ser > 0.");
//			
...
//	}
	...
	public IPaginador<Entidad> paginar(IPaginador<Entidad> pagina) throws DaoException {
		try{
			...
			Validate.isTrue(pagina.getNumeroRegistrosPorPagina() > 0, "El n�mero de registros por p�gina debe ser > 0.");
			Validate.isTrue(pagina.getFiltro() != null, "El par�metro filtro no puede ser nulo.");
